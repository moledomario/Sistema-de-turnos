...
async function main() {
    ...
    // Los turnos ya reservados sobre estos servicios se borran primero por la
    // FK RESTRICT entre appointment y ProfessionalService.
    ...
    await prisma.professionalService.createMany({
        data: [
            { user_id: professional.id, service_id: corteCabello.id, duration: 30, price: 5000 },
            { user_id: professional.id, service_id: corteBarba.id, duration: 20, price: 3500 },
        ],
    });
